$(function () {
  ...
  function setup() {
    ...
    createCollectable( "steve", 200, 650, 6, 0.7); // function createPlatform(x, y, width, height) {
      createPlatform(150, 200, 100, 20);
    createPlatform(700, 600, 200, 20); // short but wide platform located 500 pixels from the left of the screen and 300 pixels from the top of the screen
